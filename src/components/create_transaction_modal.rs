...
pub fn CreateTransactionModal() -> impl IntoView {
    ...
    let (description_input, set_description_input) = signal("".to_string());
    ...
    let on_save_click = move |_| {
        ...
        state.log(format!(
            "[CreateTransaction] adding manual transaction: date={} vendor={} description={} category={} amount_cents={} direction={:?}",
            new_txn.date, new_txn.vendor, new_txn.description, new_txn.category, new_txn.amount_cents, new_txn.direction
        ));
